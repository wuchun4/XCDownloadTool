#
#  Be sure to run `pod spec lint XCDownloadTool.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "wuchun4"
  # s.authors            = { "wuchun4" => "870396896@qq.com" }
  # s.social_media_url   = "http://twitter.com/wuchun4"
